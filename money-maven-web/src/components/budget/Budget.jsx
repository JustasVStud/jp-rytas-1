import { FaTrashAlt, FaEuroSign, FaPencilAlt, FaCalendarAlt} from "react-icons/fa";
...
function Budget({budget, onDelete}) {
  ...
  let deleteParams = {id: budget.budgetId, type: "Budget entry",
    value: budget.budgetAmount + " " + budget.budgetMonth + " " +  budget.expenseTypeName};
    ...
    <tr className="table-row">
        ...
        <td className="table-cell"><FaCalendarAlt/> {new Date(budget.budgetMonth).toLocaleDateString("lt-LT", { year: "numeric",month: "2-digit"})}</td>
